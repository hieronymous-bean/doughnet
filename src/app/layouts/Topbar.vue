          ...
          <div class="flex items-center py-3">
              <div class="hidden md:block">
                ...
                <div class="flex items-baseline space-x-4">
                  <div class="relative mx-4 lg:mx-0 text-gray-400">
                    ...
                    <input
                      class="text-sm font-light bg-gray-100 form-input w-32 sm:w-64 rounded-sm pl-10 pr-4 py-3 border-none outline-none focus:outline-none focus:ring-0"
                      type="text"
                      placeholder="Search"
                    />
                  </div>
            ...
            <div class="hidden md:block">
              <div class="ml-4 flex items-center md:ml-6">
                ...
                <button @click.prevent="openCreateAccountModal" type="button" class="py-2 px-8 mx-4 flex justify-center items-center bg-gray-100 hover:bg-gray-100 focus:ring-0 text-gray-700 w-full transition ease-in duration-200 text-center text-sm font-regular focus:outline-none rounded">
                   + Add New Account
                </button>
                ...
                <div class="ml-3" v-click-outside="closeUserMenu">
                  <button @click="toggleUserMenu" type="button" class="flex items-center justify-center w-full rounded px-4 py-2 text-sm font-medium text-gray-500 dark:text-gray-50 bg-gray-100 hover:bg-gray-100 dark:hover:bg-gray-100 focus:ring-primary-base focus:outline-none focus:ring-2 focus:ring-offset-2" id="options-menu">
