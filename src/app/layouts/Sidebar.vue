<template>
  <div :class="isSidebarOpen ? sidebarOpen : sidebarClosed" class="block overflow-hidden">
    <div class="transform bg-theme-primary-base min-h-screen" v-on:mouseover="mouseover" v-on:mouseleave="mouseleave">
      <div class="px-6 py-3">
        <img src="../../global/assets/img/logo.png" class="pr-10 pl-5 py-1">
      ...
      <nav class="pt-3 py-4 text-md text-primary-dark focus:outline-none border-t border-theme-primary-five">
        <span class="pl-3 text-theme-primary-two font-semibold text-sm">Admin</span>
        <router-link
      ...
      <nav class="py-4 text-md text-primary-dark focus:outline-none border-t border-theme-primary-five">
        <span class="pl-3 text-theme-primary-two font-semibold text-sm">Financials</span>
        ...
        >
          ...
          <span v-if="isSidebarOpen" class="text-md mx-2 pl-2">Accounts</span>
        </router-link>
        ...
        >
          ...
          <span v-if="isSidebarOpen" class="text-md mx-2 pl-2">Transactions</span>
        </router-link>
        ...
        >
          ...
          <span v-if="isSidebarOpen"  class="text-md mx-2 pl-2">Bills</span>
        </router-link>
      </nav>
      <nav class="py-4 text-md text-primary-dark focus:outline-none border-t border-theme-primary-five">
        <span class="pl-3 text-theme-primary-two font-semibold text-sm">Utilities</span>
        <router-link
          class="flex items-center py-3 px-2 mx-3 my-2 rounded-lg outline-none focus:outline-none"
        ...
        >
          ...
          <span v-if="isSidebarOpen" class="text-md mx-2 pl-2">Tools</span>
        </router-link>
        <router-link
          class="flex items-center py-3 px-2 mx-3 my-2 rounded-lg outline-none focus:outline-none"
        ...
        >
          ...
          <span v-if="isSidebarOpen"  class="text-md mx-2 pl-2">Budgets</span>
        </router-link>
        <router-link
        ...
        >
          ...
          <span v-if="isSidebarOpen"  class="text-md mx-2 pl-2">Goals</span>
        </router-link>
      </nav>
    </div>
  </div>
