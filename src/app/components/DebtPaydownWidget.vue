<template>
  <div class="">
    <div class="bg-secondary-two rounded-sm border">
      <div class="px-6 py-5 flex">
        <h2 class="flex-1">
            <span class="block font-sans text-2xl font-bold text-black">Debt Paydown</span>
            <span class="block text-md font-light text-gray-800">Widget</span>
        </h2>
