<template>
  <div class="mx-auto">
    <div class="bg-white-tint">
      <div class="mx-auto px-6 overflow-x-hidden lg:px-10">
        
        <div class="bg-white-base my-5 shadow-md">
        ...
        <div class="pb-10 mx-auto mt-4">
          <div class="grid grid-cols-3 gap-3">
          
            <AccountSummaryList :accounts="loadedAccountData" :accountTypes="loadedAccountTypes"/>
            
            <div class="bg-white-base p-4 md:flex col-span-2 shadow-md">
              <div>
                <h3 class="font-semibold text-2xl">Recent Transactions</h3>
                <p>Recently-recorded transactions for the accounts you're tracking.</p>
