<template>
    <div class="grid grid-cols-2 rounded-sm border border-gray-light py-3 px-4 cursor-pointer font-normal" @click="expandAccountType" :isThisTypeExpanded="isTypeExpanded">
      <div class="relative">
