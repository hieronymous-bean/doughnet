<template>
    <div class="grid grid-cols-2 rounded-md border border-gray-200 bg-white py-3 px-2 cursor-pointer font-normal" @click="expandAccountType" :isThisTypeExpanded="isTypeExpanded">
      <div class="relative">
...
export default {
    ...
    computed: {
      accountTypeTotal: function() {
        ...
        Object.entries(this.accountData).forEach(([val]) => {
