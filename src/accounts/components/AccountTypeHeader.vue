<template>
    <div class="grid grid-cols-2 rounded-xs border border-secondary-four bg-white py-3 px-2 cursor-pointer font-normal" @click="expandAccountType" :isThisTypeExpanded="isTypeExpanded">
      <div class="relative">
      ...
      <div v-show="isTypeExpanded" class="w-full mt-2">
