<template>
  <div class="bg-white-base p-4 md:flex shadow-md relative">
    ...
    <div class="ml-auto absolute right-4">
      <a href="#" class="text-gray-700 hover:text-theme-primary-two transition ease-in-out duration-150">
        <svg class="h-5 fill-current" viewBox="0 0 16 16">
