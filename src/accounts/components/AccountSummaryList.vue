<template>
  <div class="bg-white-base rounded-sm shadow-md">
    <div class="p-5 flex relative">
      <h2 class="flex-1 font-poppins">
        <span class="block text-3xl font-semibold text-black-base">Tracked Accounts</span>
      ...
      <div v-click-outside="closeAccountCardMenu">
        <div class="flex-2">
          <button class="focus:outline-none bg-theme-primary-base p-2 rounded-sm" @click="toggleAccountCardMenu">
        ...
        <div v-show="cardMenuOpen" class="absolute right-0 mt-0 w-48 rounded-sm shadow-md py-1 bg-white-base ring-0 font-light" role="menu" aria-orientation="vertical">
